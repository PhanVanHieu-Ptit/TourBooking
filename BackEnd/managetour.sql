...
CREATE TABLE `account` (
  ...
  `idStatus` int DEFAULT NULL COMMENT 'trạng thái tài khoản',
  PRIMARY KEY (`username`),
  KEY `idStatus` (`idStatus`),
  CONSTRAINT `account_ibfk_1` FOREIGN KEY (`idStatus`) REFERENCES `status` (`idStatus`)
...
CREATE TABLE `customer` (
  ...
  CONSTRAINT `customer_ibfk_1` FOREIGN KEY (`email`) REFERENCES `account` (`username`)
...
CREATE TABLE `staff` (
  ...
  PRIMARY KEY (`idStaff`),
  UNIQUE KEY `email` (`email`),
  CONSTRAINT `staff_ibfk_1` FOREIGN KEY (`email`) REFERENCES `account` (`username`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tour` (
  ...
  `tourcol` varchar(45) DEFAULT 'false',
  PRIMARY KEY (`idTour`),
  KEY `idStatus` (`idStatus`),
...
-- Dump completed on 2023-02-28 15:56:50
