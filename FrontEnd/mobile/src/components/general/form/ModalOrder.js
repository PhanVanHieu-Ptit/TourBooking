...
function ModalOrder(props) {
    ...
    async function getInforUser() {
        try {
            const res = await request.get(API.getInfor, { headers: user.accessToken });
            if (res.status === true) {
                    ...
                    <View style={stylesModal.centeredView}>
                        <View style={stylesModal.modalView}>
                            ...
                            <View style={{ width: 350 }}>
                                ...
                                <Text style={[stylesModal.title, { fontWeight: 'normal' }]}>
                                    Địa điểm đón: {props.DATA.detailPickUpPoint}, {props.DATA.pickUpPoint}
                                </Text>
                                <Text style={[stylesModal.title, { fontWeight: 'normal' }]}>
                                    Địa điểm đến: {props.DATA.detailTourDestination}, {props.DATA.tourDestination}
                                </Text>
                            </View>
