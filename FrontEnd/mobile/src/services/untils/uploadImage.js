...
const uploadImage = async (imageUri) => {
    ...
    const response = await fetch('https://api.imgbb.com/1/upload?key=5779224fb65d30f2f9b91e747e37ab00', {
        method: 'POST',
        headers: {
...
const deleteImage = async (idImage) => {
    ...
    // Send a DELETE request to the imgbb.com API endpoint
    const response = await fetch(`https://api.imgbb.com/1/image/nM0hvJF?key=5779224fb65d30f2f9b91e747e37ab0`, {
        method: 'DELETE',
    });
