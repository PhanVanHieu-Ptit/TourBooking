    ...
    <>
          ...
          {localStorage.token && userData ? (
            <div>
              <a
                ...
                className="user"
                onClick={() =>
                  setShowChangeUserInforPopup(!showChangeUserInforPopup)
                }
              >
                <img
              ...
              <a
                href="#"
                onClick={() => setShowOrderedTourPopup(!showOrderedTourPopup)}
              >
                Lịch sử đặt tour
              </a>
              <a
      ...
      {showOrderedTourPopup && (
        <Popup
          ...
          onClose={() => setShowOrderedTourPopup(!showOrderedTourPopup)}
        ></Popup>
      )}
